...
public class CommentController {
    ...
    public List<Comment> searchCommentsInPost(@RequestParam("post_id") Long postId, @RequestParam("query") String query) {
        List<Comment> comments = commentService.getCommentList(postId, query);
        return comments;
    }
